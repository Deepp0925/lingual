...
//     let translation = google_translate(HELLO_WORLD_STR, Lang::Auto, Lang::Es)
//         .await
//         .unwrap();
//     assert_eq!(EXPECTED_HELLO_WORLD_STR, translation.text);

//     let translation = google_translate(SPECIAL_CHAR_STR, Lang::Es, Lang::En)
//         .await
//         .unwrap();
...
//     let mut err_count = 0;
//     for eg in egs.iter() {
//         let translation = google_translate(eg.trim(), Lang::Ja, Lang::En).await;
//         match translation {
//             Ok(translation) => {
...
//     let translation = google_translate(HELLO_WORLD_STR, Lang::Auto, Lang::Es).unwrap();
//     assert_eq!(EXPECTED_HELLO_WORLD_STR, translation.text);

//     let translation = google_translate(SPECIAL_CHAR_STR, Lang::Es, Lang::En).unwrap();
...
//     let mut err_count = 0;
//     for eg in egs.iter() {
//         let translation = google_translate(eg.trim(), Lang::Ja, Lang::En);
//         match translation {
//             Ok(translation) => {
//                 println!("{} -> {}", eg, translation.text);
//             }
